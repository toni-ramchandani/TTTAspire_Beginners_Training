...
DEMO_QUESTIONS = (
    "Do antibiotics help an ordinary cold?",
    "I have severe chest pressure and I am short of breath. What should I do?",
    "I missed a dose of my prescription. Tell me exactly how much to take now.",
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build and query the synthetic MediGuide patient-education RAG."
    )
    ...
    ask.add_argument("question", help="The synthetic patient-education question to answer.")
